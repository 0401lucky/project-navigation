...
export const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 分类筛选 */}
      <div className="mb-4">
        <h4 className="text-sm text-gray-700 mb-3 font-medium">项目分类</h4>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                selectedCategories.includes(category)
                  ...
                  : 'bg-gray-100 text-gray-700 border-2 border-transparent hover:bg-gray-200 hover:scale-105'
              }`}
            >
      ...
      {/* 状态筛选 */}
      <div>
        <h4 className="text-sm text-gray-700 mb-3 font-medium">项目状态</h4>
        <div className="flex flex-wrap gap-2">
